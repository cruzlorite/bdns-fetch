# -*- coding: utf-8 -*-
"""
Integration tests for the minimis_busqueda command.
...
class TestMinimisBusquedaIntegration:
    ...
    def test_minimis_busqueda_basic_alternative(
        self, get_test_context, cleanup_test_file
    ):
        """Test minimis_busqueda command with basic parameters - alternative test from remaining commands."""
        # Arrange
        ctx, output_path = get_test_context("minimis_busqueda.csv")

...
BDNS_API_ENDPOINT_AYUDAS_ESTADO_BUSQUEDA         = f"{BDNS_API_BASE_URL}/ayudasestado/busqueda"
BDNS_API_ENDPOINT_MINIMIS_BUSQUEDA               = f"{BDNS_API_BASE_URL}/minimis/busqueda"
BDNS_API_ENDPOINT_GRANDES_BENEFICIARIOS_BUSQUEDA = f"{BDNS_API_BASE_URL}/grandesbeneficiarios/busqueda"
BDNS_API_ENDPOINT_GRANDES_BENEFICIARIOS_ANIOS    = f"{BDNS_API_BASE_URL}/grandesbeneficiarios/anios"
BDNS_API_ENDPOINT_PARTIDOS_POLITICOS_BUSQUEDA    = f"{BDNS_API_BASE_URL}/partidospoliticos/busqueda"
BDNS_API_ENDPOINT_PLANES_ESTRATEGICOS_BUSQUEDA   = f"{BDNS_API_BASE_URL}/planesestrategicos/busqueda"
BDNS_API_ENDPOINT_PLANES_ESTRATEGICOS            = f"{BDNS_API_BASE_URL}/planesestrategicos"
BDNS_API_ENDPOINT_PLANES_ESTRATEGICOS_DOCUMENTOS = f"{BDNS_API_BASE_URL}/planesestrategicos/documentos"
BDNS_API_ENDPOINT_PLANES_ESTRATEGICOS_VIGENCIA   = f"{BDNS_API_BASE_URL}/planesestrategicos/vigencia"
